...
import org.mustbe.consulo.dotnet.psi.stub.index.MemberByNamespaceQNameIndex;
...
public class DotNetPackageDescriptor implements PackageDescriptor
{
	...
	@Override
	@NotNull
	public Collection<? extends PsiElement> getChildren(@NotNull final QualifiedName qualifiedName, @NotNull GlobalSearchScope globalSearchScope,
			@NotNull Project project)
	{
		return MemberByNamespaceQNameIndex.getInstance().get(qualifiedName.toString(), project,
				globalSearchScope);
	}
}
