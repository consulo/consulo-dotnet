 ...
 * @since 18.12.13.
 */
public class CSharpMacroActiveBlockStartImpl extends CSharpElementImpl
{
	public CSharpMacroActiveBlockStartImpl(@NotNull ASTNode node)
	{
		super(node);
	}
	...
	{
		visitor.visitMacroActiveBlockStart(this);
	}
}
