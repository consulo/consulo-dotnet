 ...
 * @author peter
 */
public class CSharpTemplateDataElementType extends IFileElementType implements ITemplateDataElementType
{
	private static final Logger LOG = Logger.getInstance("#com.intellij.psi.templateLanguages.TemplateDataElementType");

	public static final LanguageExtension<TreePatcher> TREE_PATCHER = new LanguageExtension<TreePatcher>("com.intellij.lang.treePatcher",
			new SimpleTreePatcher());

	private final IElementType myTemplateElementType;
	private final IElementType myOuterElementType;

	public CSharpTemplateDataElementType(@NonNls String debugName, Language language, IElementType templateElementType,
	...
	public ASTNode parseContents(ASTNode chameleon)
	{
		...
		final Lexer lexer = new MergingLexerAdapter(new TemplateBlackAndWhiteLexer(createBaseLexer(templateFile, viewProvider), langLexer,
				myTemplateElementType, myOuterElementType), TokenSet.create(myTemplateElementType, myOuterElementType));
		lexer.start(chars);
	...
	protected PsiFile createTemplateFile(final PsiFile file, final Language language, final CharSequence chars,
	...
	protected OuterLanguageElementImpl createOuterLanguageElement(final Lexer lexer, final CharTable table, final IElementType outerElementType)
	{
