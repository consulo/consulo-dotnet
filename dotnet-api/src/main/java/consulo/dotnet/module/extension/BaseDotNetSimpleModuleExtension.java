...
public abstract class BaseDotNetSimpleModuleExtension<S extends BaseDotNetSimpleModuleExtension<S>> extends ModuleExtensionBase<S> implements DotNetSimpleModuleExtension<S>
{
	...
	@Override
	public String[] getSystemLibraryUrls(String name, OrderRootType orderRootType)
	{
		Sdk sdk = getSdk();
		if(sdk == null)
		{
	...
	protected String[] getSystemLibraryUrlsImpl(Sdk sdk, String name, OrderRootType orderRootType)
	{
