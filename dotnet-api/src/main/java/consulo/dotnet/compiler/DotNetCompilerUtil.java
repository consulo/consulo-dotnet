...
public class DotNetCompilerUtil {
    @UsedInPlugin
    public static final Predicate<OrderEntry> ACCEPT_ALL = orderEntry -> false;
    public static final Predicate<OrderEntry> SKIP_STD_LIBRARIES =
        orderEntry -> orderEntry instanceof CustomOrderEntry && ((CustomOrderEntry) orderEntry).getModel() instanceof DotNetLibraryOrderEntryModel;

    public static Set<File> collectDependencies(final Module module, final DotNetTarget target, final boolean debugSymbol, final Predicate<OrderEntry> skipCondition) {
        ...
        moduleRootManager.processOrder(new RootPolicy<>() {
            ...
            public Object visitCustomOrderEntry(CustomOrderEntry orderEntry, Object value) {
                ...
                if (model instanceof DotNetLibraryOrderEntryModel) {
                    if (skipCondition.test(orderEntry)) {
                        return null;
                    }
            ...
            public Object visitLibraryOrderEntry(LibraryOrderEntry libraryOrderEntry, Object value) {
                if (skipCondition.test(libraryOrderEntry)) {
                    return null;
                }
            ...
            public Object visitModuleOrderEntry(ModuleOrderEntry moduleOrderEntry, Object value) {
                if (skipCondition.test(moduleOrderEntry)) {
                    return null;
                }
