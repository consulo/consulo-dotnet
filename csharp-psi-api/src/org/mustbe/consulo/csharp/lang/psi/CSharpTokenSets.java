...
public interface CSharpTokenSets extends CSharpSoftTokens
{
	...
	TokenSet MODIFIERS = TokenSet.create(STATIC_KEYWORD, PUBLIC_KEYWORD, CSharpSoftTokens.PARTIAL_KEYWORD, IN_KEYWORD, OUT_KEYWORD, INTERNAL_KEYWORD,
			...
			PROTECTED_KEYWORD, VOLATILE_KEYWORD, PARAMS_KEYWORD, READONLY_KEYWORD, CSharpSoftTokens.ASYNC_KEYWORD);
	...
	TokenSet KEYWORDS = TokenSet.create(STRING_KEYWORD, STATIC_KEYWORD, CLASS_KEYWORD, USING_KEYWORD, VOID_KEYWORD, NAMESPACE_KEYWORD, NEW_KEYWORD,
			...
			CSharpSoftTokens.WHERE_KEYWORD, EVENT_KEYWORD, CSharpSoftTokens.GLOBAL_KEYWORD, CSharpSoftTokens.ADD_KEYWORD, CSharpSoftTokens.REMOVE_KEYWORD, CSharpSoftTokens.SET_KEYWORD, CSharpSoftTokens.GET_KEYWORD, BOOL_KEYWORD, BYTE_KEYWORD,
			...
			CONST_KEYWORD, BOOL_KEYWORD, NULL_LITERAL, MACRO_DEFINE_KEYWORD, MACRO_ENDIF_KEYWORD, MACRO_IF_KEYWORD);
