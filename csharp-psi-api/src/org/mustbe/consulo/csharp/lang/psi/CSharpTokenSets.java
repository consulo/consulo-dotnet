...
public interface CSharpTokenSets extends CSharpSoftTokens
{
	...
	TokenSet OVERLOADING_OPERATORS = TokenSet.create(LTEQ, GTEQ, EQEQ, PLUS, MINUS, DIV, PERC, AND, OR, TILDE, NTEQ, EXCL, CARET, GTGT, LTLT);
	...
	TokenSet KEYWORDS = TokenSet.create(STRING_KEYWORD, STATIC_KEYWORD, CLASS_KEYWORD, USING_KEYWORD, VOID_KEYWORD, NAMESPACE_KEYWORD, NEW_KEYWORD,
			...
			CONST_KEYWORD, BOOL_KEYWORD, NULL_LITERAL, MACRO_DEFINE_KEYWORD, MACRO_ENDIF_KEYWORD, MACRO_IF_KEYWORD, OPERATOR_KEYWORD);
