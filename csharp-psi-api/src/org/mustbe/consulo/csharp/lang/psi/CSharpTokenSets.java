...
public interface CSharpTokenSets extends CSharpSoftTokens
{
	...
	TokenSet BINARY_OPERATORS = TokenSet.create(NULL_COALESCING, LTEQ, GTEQ, EQEQ, PLUS, MINUS, DIV, MUL, LT, GT, PERC, AND, OR, NTEQ, EXCL, XOR,
			GTGT, LTLT, EQ);

	TokenSet CONSTANT_LITERALS = TokenSet.create(INTEGER_LITERAL, STRING_LITERAL, DOUBLE_LITERAL, DECIMAL_LITERAL, FLOAT_LITERAL, LONG_LITERAL,
			BOOL_LITERAL, NULL_LITERAL, ULONG_LITERAL, UINTEGER_LITERAL);
	...
	TokenSet KEYWORDS = TokenSet.create(STRING_KEYWORD, STATIC_KEYWORD, CLASS_KEYWORD, USING_KEYWORD, VOID_KEYWORD, NAMESPACE_KEYWORD, NEW_KEYWORD,
			...
			RETURN_KEYWORD, LOCK_KEYWORD, BREAK_KEYWORD, CONTINUE_KEYWORD, WHILE_KEYWORD, IS_KEYWORD, BASE_KEYWORD, THIS_KEYWORD);
