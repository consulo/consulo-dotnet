...
public interface CSharpTokenSets extends CSharpSoftTokens
{
	...
	TokenSet CONSTANT_LITERALS = TokenSet.create(INTEGER_LITERAL, CHARACTER_LITERAL, STRING_LITERAL, DOUBLE_LITERAL, DECIMAL_LITERAL, FLOAT_LITERAL,
			LONG_LITERAL,
	...
	TokenSet KEYWORDS = TokenSet.create(STRING_KEYWORD, STATIC_KEYWORD, CLASS_KEYWORD, USING_KEYWORD, VOID_KEYWORD, NAMESPACE_KEYWORD, NEW_KEYWORD,
			...
			DO_KEYWORD, FOR_KEYWORD, TRY_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, THROW_KEYWORD);
