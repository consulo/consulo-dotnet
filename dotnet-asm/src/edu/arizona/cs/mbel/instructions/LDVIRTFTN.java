...
public class LDVIRTFTN extends Instruction
{
	 ...
	 */
	public LDVIRTFTN(MethodDefOrRef ref) throws InstructionInitException
	{
	...
	public LDVIRTFTN(int opcode, ModuleParser parse) throws IOException, InstructionInitException
	{
