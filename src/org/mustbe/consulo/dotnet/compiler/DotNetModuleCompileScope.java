 ...
 * Time: 5:34:19 PM
 *
 * Some copy of @see {com.intellij.compiler.impl.ModuleCompileScope}
 */
public class DotNetModuleCompileScope extends FileIndexCompileScope
{
	private final Project myProject;
	private final Set<Module> myScopeModules;
	private final Module[] myModules;

	public DotNetModuleCompileScope(final Module module, boolean includeDependentModules)
	{
	...
	public DotNetModuleCompileScope(Project project, final Module[] modules, boolean includeDependentModules)
	{
		myProject = project;
		myScopeModules = new HashSet<Module>();
	...
	public VirtualFile[] getFiles(final FileType fileType, final boolean inSourceOnly)
	{
		...
		{
			fileIndex.iterateContent(new DotNetCompilerContentIterator(fileType, fileIndex, inSourceOnly, files));
		}
