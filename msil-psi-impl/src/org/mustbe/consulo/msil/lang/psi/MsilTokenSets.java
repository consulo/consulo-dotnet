...
public interface MsilTokenSets extends MsilTokens
{
	...
	TokenSet IDENTIFIERS_AND_CTOR = TokenSet.create(IDENTIFIER, QIDENTIFIER, _CTOR_KEYWORD);
	...
	TokenSet _KEYWORDS = TokenSet.create(_CLASS_KEYWORD, _FIELD_KEYWORD, _PROPERTY_KEYWORD, _METHOD_KEYWORD, _ASSEMBLY_KEYWORD, _EVENT_KEYWORD,
			_CUSTOM_KEYWORD, _PARAM_KEYWORD, _ADDON_KEYWORD, _REMOVEON_KEYWORD, _SET_KEYWORD, _GET_KEYWORD, _CTOR_KEYWORD);
