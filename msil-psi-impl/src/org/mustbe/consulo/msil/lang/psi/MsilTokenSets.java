...
public interface MsilTokenSets extends MsilTokens
{
	...
	TokenSet KEYWORDS = TokenSet.create(INT32_KEYWORD, INT64_KEYWORD, CLASS_KEYWORD, VALUETYPE_KEYWORD, VOID_KEYWORD, BOOL_KEYWORD, OBJECT_KEYWORD,
			...
			UINT32_KEYWORD, INT16_KEYWORD, UINT16_KEYWORD, CHAR_KEYWORD, PUBLIC_KEYWORD, STATIC_KEYWORD, ABSTRACT_KEYWORD, FINAL_KEYWORD,
			PRIVATE_KEYWORD, LITERAL_KEYWORD, ASSEMBLY_KEYWORD, INITONLY_KEYWORD, HIDEBYSIG_KEYWORD, VIRTUAL_KEYWORD, PROTECTED_KEYWORD,
			BRACKET_OUT_KEYWORD, VALUE_KEYWORD, INTERFACE_KEYWORD, SERIALIZABLE_KEYWORD, SEALED_KEYWORD, SPECIALNAME_KEYWORD);
