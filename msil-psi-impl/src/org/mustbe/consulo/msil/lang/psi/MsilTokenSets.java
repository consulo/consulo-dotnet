...
public interface MsilTokenSets extends MsilTokens
{
	...
	ModifierElementType[] MODIFIERS_AS_ARRAY = {
			PUBLIC_KEYWORD,
			STATIC_KEYWORD,
			ABSTRACT_KEYWORD,
			FINAL_KEYWORD,
	...
	TokenSet NATIVE_TYPES = TokenSet.create(INT32_KEYWORD, INT64_KEYWORD, VOID_KEYWORD, BOOL_KEYWORD, OBJECT_KEYWORD, STRING_KEYWORD,
			UINT64_KEYWORD, FLOAT_KEYWORD, INT8_KEYWORD, UINT8_KEYWORD, FLOAT64_KEYWORD, UINT32_KEYWORD, INT16_KEYWORD, UINT16_KEYWORD,
			CHAR_KEYWORD, INT_KEYWORD, UINT_KEYWORD);
