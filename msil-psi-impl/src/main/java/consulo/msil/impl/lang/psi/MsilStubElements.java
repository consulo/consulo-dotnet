...
import consulo.msil.impl.lang.psi.impl.MsilArrayTypeImpl;
import consulo.msil.impl.lang.psi.impl.MsilPointerTypeImpl;
import consulo.msil.impl.lang.psi.impl.MsilTypeByRefImpl;
import consulo.msil.impl.lang.psi.impl.MsilTypeWithTypeArgumentsImpl;
import consulo.msil.impl.lang.psi.impl.elementType.*;
...
public interface MsilStubElements
{
	...
	{
		@Override
		public DotNetType createElement(ASTNode astNode)
		{
			return new MsilPointerTypeImpl(astNode);
		}

		@Override
		public DotNetType createPsi(MsilEmptyTypeStub msilEmptyTypeStub)
		{
