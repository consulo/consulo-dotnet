...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:ExtractHashAlgorithmIdElemType interface.
 *
 * @author VISTALL
 */
public interface ExtractHashAlgorithmId extends DomElement, Task
{
	...
	/**
	 * Returns the value of the HashUris child.
	 *
	 * @return the value of the HashUris child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<String> getHashUris();
