...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:ParsePlatformSpecificBundleArtifactsListsElemType interface.
 *
 * @author VISTALL
 */
public interface ParsePlatformSpecificBundleArtifactsLists extends DomElement, Task
{
	...
	/**
	 * Returns the value of the Artifacts child.
	 *
	 * @return the value of the Artifacts child.
	 */
	@NotNull
	GenericAttributeValue<String> getArtifacts();
