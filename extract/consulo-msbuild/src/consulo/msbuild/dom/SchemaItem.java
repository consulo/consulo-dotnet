...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:SchemaItemType interface.
 *
 * @author VISTALL
 */
public interface SchemaItem extends DomElement, SimpleItem
{
	...
	/**
	 * Returns the value of the NamespaceAlias child.
	 * <pre>
	 * <h3>Element http://schemas.microsoft.com/developer/msbuild/2003:NamespaceAlias documentation</h3>
	 * <!-- _locID_text="AppxManifestSchema_NamespaceAlias" _locComment="" -->Namespace alias used for this schema.
	 * </pre>
	 *
	 * @return the value of the NamespaceAlias child.
	 */
	@NotNull
	@Required
	GenericDomValue<String> getNamespaceAlias();


	/**
	 * Returns the value of the NamespaceUri child.
	 * <pre>
	 * <h3>Element http://schemas.microsoft.com/developer/msbuild/2003:NamespaceUri documentation</h3>
	 * <!-- _locID_text="AppxManifestSchema_NamespaceUri" _locComment="" -->Namespace URI used for this schema.
	 * </pre>
	 *
	 * @return the value of the NamespaceUri child.
	 */
	@NotNull
	@Required
	GenericDomValue<String> getNamespaceUri();
