...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:AssignTargetPathElemType interface.
 *
 * @author VISTALL
 */
public interface AssignTargetPath extends DomElement, Task
{
	...
	/**
	 * Returns the value of the RootFolder child.
	 *
	 * @return the value of the RootFolder child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<String> getRootFolder();
