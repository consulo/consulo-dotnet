...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:CombinePathElemType interface.
 *
 * @author VISTALL
 */
public interface CombinePath extends DomElement, Task
{

	/**
	 * Returns the value of the BasePath child.
	 *
	...
	/**
	 * Returns the value of the CombinedPaths child.
	 *
