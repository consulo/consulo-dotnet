...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:_AppxBundleResourceFileMapsIntermediateElemType interface.
 *
 * @author VISTALL
 */
public interface _AppxBundleResourceFileMapsIntermediate extends DomElement, SimpleItem
{
	 ...
	 */
	@NotNull
	GenericDomValue<String> getResourcePack();
