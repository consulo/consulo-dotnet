...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:TlbImpElemType interface.
 *
 * @author VISTALL
 */
public interface TlbImp extends DomElement, Task
{

	/**
	 * Returns the value of the AssemblyNamespace child.
	 *
	...
	/**
	 * Returns the value of the PreventClassMembers child.
	 *
	...
	/**
	 * Returns the value of the SafeArrayAsSystemArray child.
	 *
	...
	/**
	 * Returns the value of the Transform child.
	 *
	...
	/**
	 * Returns the value of the TypeLibName child.
	 *
