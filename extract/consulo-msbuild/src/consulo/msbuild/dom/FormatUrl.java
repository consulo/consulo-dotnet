...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:FormatUrlElemType interface.
 *
 * @author VISTALL
 */
public interface FormatUrl extends DomElement, Task
{
	 ...
	 *
	 * @return the value of the InputUrl child.
	 */
	@NotNull
	 ...
	 *
	 * @return the value of the OutputUrl child.
	 */
	@NotNull
