...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:FormatVersionElemType interface.
 *
 * @author VISTALL
 */
public interface FormatVersion extends DomElement, Task
{

	/**
	 * Returns the value of the FormatType child.
	 *
	 * @return the value of the FormatType child.
	 */
	@NotNull
	GenericAttributeValue<String> getFormatType();


	/**
	 * Returns the value of the OutputVersion child.
	 *
	 * @return the value of the OutputVersion child.
	 */
	@NotNull
	GenericAttributeValue<String> getOutputVersion();


	/**
	 * Returns the value of the Revision child.
	 *
	 * @return the value of the Revision child.
	 */
	@NotNull
	GenericAttributeValue<String> getRevision();
