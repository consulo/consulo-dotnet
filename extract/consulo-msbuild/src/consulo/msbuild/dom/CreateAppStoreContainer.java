...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:CreateAppStoreContainerElemType interface.
 *
 * @author VISTALL
 */
public interface CreateAppStoreContainer extends DomElement, Task
{

	/**
	 * Returns the value of the Items child.
	 *
	 * @return the value of the Items child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<String> getItems();
