 ...
 * @author VISTALL
 */
public interface XDCMake extends DomElement, Task
{
	...
	/**
	 * Returns the value of the AdditionalDocumentFile child.
	 *
	 * @return the value of the AdditionalDocumentFile child.
	 */
	@NotNull
	@Required
	GenericDomValue<String> getAdditionalDocumentFile();


	/**
	 * Returns the value of the DocumentLibraryDependencies child.
	 *
	 * @return the value of the DocumentLibraryDependencies child.
	 */
	@NotNull
	@Required
	GenericDomValue<String> getDocumentLibraryDependencies();
