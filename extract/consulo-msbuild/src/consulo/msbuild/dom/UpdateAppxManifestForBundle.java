...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:UpdateAppxManifestForBundleElemType interface.
 *
 * @author VISTALL
 */
public interface UpdateAppxManifestForBundle extends DomElement, Task
{

	/**
	 * Returns the value of the FinalAppxManifest child.
	 *
	...
	/**
	 * Returns the value of the AppxManifestForBundle child.
	 *
