...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:_PackagingOutputsUnexpandedElemType interface.
 *
 * @author VISTALL
 */
public interface _PackagingOutputsUnexpanded extends DomElement, SimpleItem
{
	 ...
	 */
	@NotNull
	StringProperty getTargetPath();


	/**
	 * Returns the value of the OutputGroup child.
	 *
	 * @return the value of the OutputGroup child.
	 */
	@NotNull
	GenericDomValue<String> getOutputGroup();
	 ...
	 */
	@NotNull
	GenericDomValue<String> getProjectName();
