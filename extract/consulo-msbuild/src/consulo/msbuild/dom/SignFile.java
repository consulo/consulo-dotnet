...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:SignFileElemType interface.
 *
 * @author VISTALL
 */
public interface SignFile extends DomElement, Task
{
	...
	/**
	 * Returns the value of the SigningTarget child.
	 *
	...
	/**
	 * Returns the value of the TimestampUrl child.
	 *
