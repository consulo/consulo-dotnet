...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:WriteLinesToFileElemType interface.
 *
 * @author VISTALL
 */
public interface WriteLinesToFile extends DomElement, Task
{
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getLines();


	/**
	 * Returns the value of the Overwrite child.
	 *
	 * @return the value of the Overwrite child.
	 */
	@NotNull
