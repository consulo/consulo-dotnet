...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:ConvertToAbsolutePathElemType interface.
 *
 * @author VISTALL
 */
public interface ConvertToAbsolutePath extends DomElement, Task
{

	/**
	 * Returns the value of the AbsolutePaths child.
	 *
	 * @return the value of the AbsolutePaths child.
	 */
	@NotNull
	GenericAttributeValue<String> getAbsolutePaths();


	/**
	 * Returns the value of the Paths child.
	 *
