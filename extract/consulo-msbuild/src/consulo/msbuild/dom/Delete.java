...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:DeleteElemType interface.
 *
 * @author VISTALL
 */
public interface Delete extends DomElement, Task
{
	...
	/**
	 * Returns the value of the TreatErrorsAsWarnings child.
	 *
	 * @return the value of the TreatErrorsAsWarnings child.
	 */
	@NotNull
	GenericAttributeValue<Boolean> getTreatErrorsAsWarnings();
