...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:COMFileReferenceElemType interface.
 *
 * @author VISTALL
 */
public interface COMFileReference extends DomElement, SimpleItem
{
	...
	/**
	 * Returns the value of the WrapperTool child.
	 *
	 * @return the value of the WrapperTool child.
	 */
	@NotNull
	@Required
	GenericDomValue<String> getWrapperTool();
