...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:TelemetryElemType interface.
 *
 * @author VISTALL
 */
public interface Telemetry extends DomElement, Task
{

	/**
	 * Returns the value of the EventName child.
	 *
	 * @return the value of the EventName child.
	 */
	@NotNull
	@Required
	...
	/**
	 * Returns the value of the EventData child.
	 *
	 * @return the value of the EventData child.
	 */
	@NotNull
	GenericAttributeValue<String> getEventData();
