...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:GenerateProjectArchitecturesFileElemType interface.
 *
 * @author VISTALL
 */
public interface GenerateProjectArchitecturesFile extends DomElement, Task
{
	 ...
	 *
	 * @return the value of the ProjectArchitectures child.
	 */
	@NotNull
	@Required
	 ...
	 *
	 * @return the value of the ProjectArchitecturesFilePath child.
	 */
	@NotNull
	@Required
