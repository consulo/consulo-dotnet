...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:MessageElemType interface.
 *
 * @author VISTALL
 */
public interface Message extends DomElement, Task
{
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getImportance();
