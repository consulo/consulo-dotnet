...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:GetDefaultResourceLanguageElemType interface.
 *
 * @author VISTALL
 */
public interface GetDefaultResourceLanguage extends DomElement, Task
{

	/**
	 * Returns the value of the DefaultLanguage child.
	 *
	 * @return the value of the DefaultLanguage child.
	 */
	@NotNull
	GenericAttributeValue<String> getDefaultLanguage();
