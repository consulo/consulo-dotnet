...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:ProjectConfigurationElemType interface.
 *
 * @author VISTALL
 */
public interface ProjectConfiguration extends DomElement, SimpleItem
{
	...
	@NotNull
	@Required
	GenericDomValue<String> getConfiguration();
	...
	@NotNull
	@Required
	GenericDomValue<String> getPlatform();
