...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:GetReferenceAssemblyPathsElemType interface.
 *
 * @author VISTALL
 */
public interface GetReferenceAssemblyPaths extends DomElement, Task
{

	/**
	 * Returns the value of the RootPath child.
	 *
	 * @return the value of the RootPath child.
	 */
	@NotNull
	GenericAttributeValue<String> getRootPath();
	...
	/**
	 * Returns the value of the BypassFrameworkInstallChecks child.
	 *
	 * @return the value of the BypassFrameworkInstallChecks child.
	 */
	@NotNull
	GenericAttributeValue<String> getBypassFrameworkInstallChecks();
