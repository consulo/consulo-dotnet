...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:CreateVisualBasicManifestResourceNameElemType interface.
 *
 * @author VISTALL
 */
public interface CreateVisualBasicManifestResourceName extends DomElement, Task
{

	/**
	 * Returns the value of the PrependCultureAsDirectory child.
	 *
	 * @return the value of the PrependCultureAsDirectory child.
	 */
	@NotNull
	GenericAttributeValue<Boolean> getPrependCultureAsDirectory();


	/**
	 * Returns the value of the ResourceFiles child.
	 *
	 * @return the value of the ResourceFiles child.
	 */
	@NotNull
	@Required
	GenericAttributeValue<String> getResourceFiles();


	/**
	 * Returns the value of the ResourceFilesWithManifestResourceNames child.
	 *
	 * @return the value of the ResourceFilesWithManifestResourceNames child.
	 */
	@NotNull
	GenericAttributeValue<String> getResourceFilesWithManifestResourceNames();
