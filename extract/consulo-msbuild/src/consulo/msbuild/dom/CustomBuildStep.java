...
/**
 * http://schemas.microsoft.com/developer/msbuild/2003:CustomBuildStepElemType interface.
 *
 * @author VISTALL
 */
public interface CustomBuildStep extends DomElement, SimpleItem
{
	...
	/**
	 * Returns the list of Outputs children.
	 *
	 * @return the list of Outputs children.
	 */
	@NotNull
	List<GenericDomValue<String>> getOutputses();

	/**
	 * Adds new child to the list of Outputs children.
	 *
	 * @return created child
	 */
	GenericDomValue<String> addOutputs();
	...
	/**
	 * Returns the list of Inputs children.
	 *
	 * @return the list of Inputs children.
	 */
	@NotNull
	List<GenericDomValue<String>> getInputses();

	/**
	 * Adds new child to the list of Inputs children.
	 *
	 * @return created child
	 */
	GenericDomValue<String> addInputs();
