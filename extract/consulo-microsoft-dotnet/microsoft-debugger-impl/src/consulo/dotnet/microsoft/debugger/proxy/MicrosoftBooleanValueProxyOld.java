 ...
 */
@Deprecated
public class MicrosoftBooleanValueProxyOld extends MicrosoftValueProxyBaseOld<BooleanValueResult> implements DotNetBooleanValueProxy
{
	private MicrosoftDebuggerClient myClient;

	public MicrosoftBooleanValueProxyOld(MicrosoftDebuggerClient client, BooleanValueResult value)
	{
		super(value);
		myClient = client;
	}
