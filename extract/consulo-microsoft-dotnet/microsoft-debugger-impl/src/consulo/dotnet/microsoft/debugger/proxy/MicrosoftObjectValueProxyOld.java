 ...
 */
@Deprecated
public class MicrosoftObjectValueProxyOld extends MicrosoftValueProxyBaseOld<ObjectValueResult> implements DotNetObjectValueProxy
{
	private MicrosoftDebuggerClient myClient;
	private Getter<DotNetTypeProxy> myType;

	public MicrosoftObjectValueProxyOld(MicrosoftDebuggerClient client, ObjectValueResult result)
	{
		super(result);
		myClient = client;
