 ...
 */
@Deprecated
public class MicrosoftArrayValueProxyOld extends MicrosoftValueProxyBaseOld<ArrayValueResult> implements DotNetArrayValueProxy
{
	private Getter<DotNetTypeProxy> myType;
	private MicrosoftDebuggerClient myClient;

	public MicrosoftArrayValueProxyOld(MicrosoftDebuggerClient client, ArrayValueResult result)
	{
		super(result);
		myClient = client;
