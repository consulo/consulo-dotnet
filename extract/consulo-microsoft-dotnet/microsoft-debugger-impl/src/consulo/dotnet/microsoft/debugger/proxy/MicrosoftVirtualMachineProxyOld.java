 ...
 */
@Deprecated
public class MicrosoftVirtualMachineProxyOld implements DotNetVirtualMachineProxy
{
	private MicrosoftDebuggerClient myContext;

	public MicrosoftVirtualMachineProxyOld(MicrosoftDebuggerClient context)
	{
		myContext = context;
	}
	...
	public List<DotNetThreadProxy> getThreads()
	{
		...
		{
			proxies.add(new MicrosoftThreadProxyOld(thread.Id, thread.Name, myContext));
		}
		return proxies;
	}
