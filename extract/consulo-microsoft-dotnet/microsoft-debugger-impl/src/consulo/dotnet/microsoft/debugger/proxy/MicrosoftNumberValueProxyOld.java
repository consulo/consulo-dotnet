 ...
 */
@Deprecated
public class MicrosoftNumberValueProxyOld extends MicrosoftValueProxyBaseOld<NumberValueResult> implements DotNetNumberValueProxy
{
	private MicrosoftDebuggerClient myClient;

	public MicrosoftNumberValueProxyOld(MicrosoftDebuggerClient client, NumberValueResult result)
	{
		super(result);
		myClient = client;
	}
