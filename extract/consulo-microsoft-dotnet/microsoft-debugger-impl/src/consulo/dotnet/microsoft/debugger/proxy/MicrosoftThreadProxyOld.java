 ...
 */
@Deprecated
public class MicrosoftThreadProxyOld extends DotNetThreadProxy
{
	private int myId;
	private String myName;
	private MicrosoftDebuggerClient myContext;

	public MicrosoftThreadProxyOld(int id, String name, MicrosoftDebuggerClient context)
	{
		myId = id;
		myName = name;
		myContext = context;
	...
	public List<DotNetStackFrameProxy> getFrames()
	{
		...
		for(int i = 0; i < frames.length; i++)
		{
			...
			proxies.add(new MicrosoftStackFrameProxyOld(myContext, this, i, frame));
		}
		return proxies;
	}
}
